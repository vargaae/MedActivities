...
import {
  subscribeActivitySession,
  getActivitySessionVersion,
  getActivityToken,
} from "../api/activitySession";
...
function activityWritePayload(a: ActivityWrite) {
  return {
    ...
    id: a.id,
    title: a.title,
    date: a.date instanceof Date ? localDateTime(a.date) : a.date,
    ...
    practitionerIds: a.practitionerIds,
  };
}
